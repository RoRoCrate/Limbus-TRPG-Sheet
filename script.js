document.addEventListener('DOMContentLoaded', () => {
    ...
    const SEARCH_FIELDS = {
        ...
        'suppassive': [
            ...
            { id: 'search_sp_price', label: '価格(通常：LP 死亡：欠片)', type: 'text', csvKey: '価格', placeholder: '0～' }
        ],
        'mental': [
            { id: 'search_mental_name', label: '名称', type: 'text', csvKey: '名称', placeholder: '萎縮...' },
            { id: 'search_mental_price', label: '価格(欠片)', type: 'text', csvKey: '価格', placeholder: '0～' }
        ],
        'item': [
            ...
            { id: 'search_item_price', label: '価格(LP)', type: 'text', csvKey: '価格', placeholder: '0～' }
        ],
        'status': [
